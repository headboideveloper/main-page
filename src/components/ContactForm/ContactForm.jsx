          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                ...
                <option value="school-partnership">School Partnership Programme</option>
                <option value="home-lessons">Home Lessons — We come to you</option>
                <option value="online-sessions">Live Online Sessions</option>
                <option value="individual-oneonone">Individual One on One Sessions</option>
                <option value="small-group">Small Group Sessions</option>
                <option value="english-maths">English Language or Mathematics Tutoring</option>
