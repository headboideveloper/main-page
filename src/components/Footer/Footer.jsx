...
const Footer = () => {
  return (
//     <div className='h-[150px] md:mt-[-80px] max-w-screen bg-gray-100 mt-[640px] py-12 text-center text-gray-400 md:py-10'>
...
// </div>
          ...
          <div className='max-w-screen px-4 bg-white mt-[750px] md:mt-[-80px] py-10 text-gray-400'>
